...
// The old Arduino version needed SD.h before M5GFX.h or the formatter
// broke the build. Pure ESP-IDF port: no Arduino, no problem.
...
// Manga root (SD card is mounted at /sdcard via esp_vfs_fat_sdspi)
