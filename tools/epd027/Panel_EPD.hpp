/*----------------------------------------------------------------------------/
  ...
  M5MangaS3Plus NOTE: M5GFX 0.2.7's Panel_EPD.hpp verbatim. Installed over
  the managed M5GFX copy by tools/patch_m5gfx_epd.py - see note in
  tools/epd027/Panel_EPD.cpp.
  Original Source:
